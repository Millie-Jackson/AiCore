...
class scraper:
    ...
    @exceptionHandling
    def __search(self, searchTerm) -> None:
        '''
    ...
    @exceptionHandling
    def __findSearchbar(self, searchTerm) -> None:
        '''
    ...
    def __getAllRecipePages(self, url) -> None:
        '''
